	        ...
	        <?php
	              ...
	              $do_not_duplicate[] = $post->ID; ?>
								<div class="post-content">
									<a class="inner">
										<figure <?php if ( $id = get_post_thumbnail_id() ) { if ( $src = wp_get_attachment_url( $id ) ) printf( ' style="background-image: url(%s);"', $src );} ?>></figure>
											<figcaption>
	        ...
	        <?php
	              ...
	              $do_not_duplicate[] = $post->ID; ?>
								<article class="post-content">
									<a class="inner">
										<figure <?php if ( $id = get_post_thumbnail_id() ) { if ( $src = wp_get_attachment_url( $id ) ) printf( ' style="background-image: url(%s);"', $src );} ?>>
												<figcaption>
													<div class="post-cat"><?php the_category(', '); ?></div>
													<h2 class="post-title"><a><?php the_title(); ?></a></h2>
													<div class="post-publ-info">
